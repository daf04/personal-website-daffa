    ...
    <div>
      ...
      <div ref={container} className="home-container h-full mx-5 mt-40 md:gap-14 lg:mx-44">
       <div className="mt-10 flex flex-col justify-center items-center">
          <h1 className="text-[30px] font-bold lg:text-4xl mb-2 text-slate-500 text-awal">Website and Mobile Application Creation Services</h1>
          ...
          {/* <h1 className="mx-5 md:mx-0 mb-2 sm:mb-0 font-bold text-slate-800 text-lg sm:text-base lg:text-3xl text-tengah"> 
            I do   */}
            <span className="inline-block ml-1 mx-5 md:mx-0 mb-2 sm:mb-0 font-bold text-slate-800 text-lg sm:text-base lg:text-3xl text-tengah">
              <Typewriter 
              options={{
                strings : ["Website Design.", "E-Commerce.", "Mobile Application.", "Search Engine Optimazation."],
                autoStart : true,
                loop : true,  
                delay : 70,
                // deleteSpeed : 100,
